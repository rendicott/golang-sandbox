...
func main() {
	...
	*/
	...
	/*
	   ...
	   form of receive, the more value will be false if
	   jobs has been closed and all values in the channel
	   have already been received. We use this to notify
	   on done when we've worked all our jobs.
	*/
	go func() {
		for {
			j, more := <-jobs
...
/*
C:\>go run 30_closing-channels.go
sent job 1
sent job 2
sent job 3
sent all jobs

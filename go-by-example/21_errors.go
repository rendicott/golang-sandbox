...
This contrasts with the exceptions used in
languages like Java and Ruby and the
overloaded single result / error value
sometimes used in C. Go’s approach makes
it easy to see which functions return errors
...
Here’s a variant on the example above that
...
a new struct, supplying values for the two fields arg and prob.
*/
...
func main() {
	/*
	   ...
	   functions. Note that the use of an inline error check on
	...
	*/
	...
	/*
	   ...
	   a custom error, you’ll need to get the error as

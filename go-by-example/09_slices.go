...
func main() {
	...
	*/
	...
	// We can declare and init a var for slice in a single line
	t := []string{"g", "h", "i"}
	fmt.Println("dcl:", t)
	...
	*/
	...
	fmt.Println("2d: ", twoD)
	/*
		Note that while slices are different types than
		arrays, they are rendered similarly by fmt.Println.
	*/
}

/*
Check out this great blog post by the Go team for more
